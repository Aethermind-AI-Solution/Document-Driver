...
export default function Home(){
 const [schemas,setSchemas]=useState<Schema[]>([]),[docs,setDocs]=useState<Doc[]>([]),[type,setType]=useState("auto"),[selected,setSelected]=useState<any>(null),[loading,setLoading]=useState(false),[message,setMessage]=useState(""),[agentEvents,setAgentEvents]=useState<AgentEvent[]>([]),[retrying,setRetrying]=useState<number|null>(null); const input=useRef<HTMLInputElement>(null); const activityId=useRef(0);
