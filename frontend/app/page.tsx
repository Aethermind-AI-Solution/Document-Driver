...
type Schema={key:string,name:string,fields:unknown[]}; type Doc={id:number,filename:string,document_type:string,status:string,confidence?:number,upload_date:string,review_required:boolean,processing_time?:number|null,pipeline_trace?:TraceEntry[]|null,anomalies?:string[]|null,auto_approved?:boolean};
