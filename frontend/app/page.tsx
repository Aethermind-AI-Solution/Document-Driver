...
export default function Home(){
 ...
 const [q,setQ]=useState(""),[statusFilter,setStatusFilter]=useState(""),[offset,setOffset]=useState(0),[total,setTotal]=useState(0),[stats,setStats]=useState<{total:number,review_required:number,avg_processing_time:number|null,field_agreement_rate:number|null}|null>(null);
